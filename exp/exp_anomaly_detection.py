...
from utils.tools import EarlyStopping, adjust_learning_rate, adjustment, coverage_based_adjustment, \
...
class Exp_Anomaly_Detection(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        if not self.args.flag_anomaly_sliding_window_threshold:
            attens_energy = np.concatenate(attens_energy, axis=0).reshape(-1)
            ...
            print("flag_anomaly_sliding_window_threshold TRUE   th_factor: ", th_factor)
